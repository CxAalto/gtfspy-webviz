...
class GtfsService {
  ...
  fetch_stats() {
    ...
    const deferred = this.$q.defer();
    this.$http.get(this.pp+"/gtfsstats?dbfname="+dbfname)
        .success( json => {
  ...
  get_anim_trips() {
    ...
    if (this.cache[cstr]) {
      ...
      this.$http.get(this.pp+"/gtfs_viz?tstart="+start_time+"&tend="+end_time +
  ...
  get_spreading_trips() {
    ...
    const deferred = this.$q.defer();
    this.$http.get(this.pp + "/spreading?tstart="+start_time+"&tend="+end_time+"&lat="+lat+"&lon="+lon+"&dbfname="+dbfname)
      .success( json => {
                const trip_data = json['trips'];
